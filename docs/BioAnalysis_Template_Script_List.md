...
| 02 genome survey | `scripts/02_genome_survey/run_ploidyngs_workflow.sh` | Reference-derived; cleaned wrapper | Coordinate-sorted WGS BAM | ploidyNGS table, histogram PDF, runtime log, and manifest |
